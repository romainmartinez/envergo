...
The torque-angle-velocity matrix (41 angles by 73 velocities) was flattened into a vector (2993 points) to allow the statistical tests to be conducted using statiscal parametric mapping [@Pataky2010].
